...
var Caml_io                  = __webpack_require__(23);
var Caml_obj                 = __webpack_require__(2);
var Caml_sys                 = __webpack_require__(10);
...
var Invalid_copy = Caml_exceptions.create("Util.Board.Invalid_copy");
...
function width(l) {
  return Caml_array.caml_array_get(l, 0).length;
}

function set(i, j, a, b) {
  return Caml_array.caml_array_set(Caml_array.caml_array_get(b, i), j, a);
}

function set_row(i, b, row) {
  return Caml_array.caml_array_set(b, i, row);
}

function get_row(i, b) {
  return Caml_array.caml_array_get(b, i);
}

function get(i, j, b) {
  return Caml_array.caml_array_get(Caml_array.caml_array_get(b, i), j);
}

function update_row(i, f, b) {
  var b$1 = Caml_array.caml_array_get(b, i);
  for(var i$1 = 0 ,i_finish = b$1.length - 1 | 0; i$1 <= i_finish; ++i$1){
    Caml_array.caml_array_set(b$1, i$1, Curry._1(f, Caml_array.caml_array_get(b$1, i$1)));
  }
  return /* () */0;
}

function update(f, b) {
  for(var i = 0 ,i_finish = b.length - 1 | 0; i <= i_finish; ++i){
    update_row(i, f, b);
  }
  return /* () */0;
}

function of_matrix(m) {
  return m;
}

function copy(b1, b2, def, y, x) {
  var match_000 = b1.length;
  var match_001 = Caml_array.caml_array_get(b1, 0).length;
  var w1 = match_001;
  for(var i = 0 ,i_finish = match_000 - 1 | 0; i <= i_finish; ++i){
    for(var j = 0 ,j_finish = w1 - 1 | 0; j <= j_finish; ++j){
      if (Caml_obj.caml_notequal(Caml_array.caml_array_get(Caml_array.caml_array_get(b1, i), j), def)) {
        Caml_array.caml_array_set(Caml_array.caml_array_get(b2, i + y | 0), j + x | 0, Caml_array.caml_array_get(Caml_array.caml_array_get(b1, i), j));
      }
...
function print(p, b) {
  for(var i = 0 ,i_finish = b.length - 1 | 0; i <= i_finish; ++i){
    for(var j = 0 ,j_finish = Caml_array.caml_array_get(b, 0).length - 1 | 0; j <= j_finish; ++j){
      Curry._1(p, Caml_array.caml_array_get(Caml_array.caml_array_get(b, i), j));
      if (j !== (Caml_array.caml_array_get(b, 0).length - 1 | 0)) {
...
function rotate(b) {
  var match_000 = b.length;
  var match_001 = Caml_array.caml_array_get(b, 0).length;
  var w = match_001;
  var h = match_000;
  var cashe = $$Array.make_matrix(h, w, /* None */0);
  for(var i = 0 ,i_finish = h - 1 | 0; i <= i_finish; ++i){
    for(var j = 0 ,j_finish = w - 1 | 0; j <= j_finish; ++j){
      Caml_array.caml_array_set(Caml_array.caml_array_get(cashe, j), (w - i | 0) - 1 | 0, /* Some */[Caml_array.caml_array_get(Caml_array.caml_array_get(b, j), (w - i | 0) - 1 | 0)]);
      var match = Caml_array.caml_array_get(Caml_array.caml_array_get(cashe, i), j);
      if (match) {
        Caml_array.caml_array_set(Caml_array.caml_array_get(b, j), (w - i | 0) - 1 | 0, match[0]);
      } else {
        Caml_array.caml_array_set(Caml_array.caml_array_get(b, j), (w - i | 0) - 1 | 0, Caml_array.caml_array_get(Caml_array.caml_array_get(b, i), j));
      }
    }
  }
  return /* () */0;
...
function rotate_rev(b) {
  ...
  for(var i = 0 ,i_finish = h - 1 | 0; i <= i_finish; ++i){
    for(var j = 0 ,j_finish = w - 1 | 0; j <= j_finish; ++j){
      Caml_array.caml_array_set(Caml_array.caml_array_get(cashe, i), j, /* Some */[Caml_array.caml_array_get(Caml_array.caml_array_get(b, i), j)]);
      var match = Caml_array.caml_array_get(Caml_array.caml_array_get(cashe, j), (w - i | 0) - 1 | 0);
      if (match) {
        Caml_array.caml_array_set(Caml_array.caml_array_get(b, i), j, match[0]);
      } else {
        Caml_array.caml_array_set(Caml_array.caml_array_get(b, i), j, Caml_array.caml_array_get(Caml_array.caml_array_get(b, j), (w - i | 0) - 1 | 0));
      }
    }
  }
  return /* () */0;
...
function dup(b) {
  return $$Array.init(b.length, (function (i) {
                return $$Array.copy(Caml_array.caml_array_get(b, i));
              }));
}

function for_all_row(f, i, b) {
  try {
    for(var j = 0 ,j_finish = Caml_array.caml_array_get(b, 0).length - 1 | 0; j <= j_finish; ++j){
      if (!Curry._1(f, Caml_array.caml_array_get(Caml_array.caml_array_get(b, i), j))) {
        Pervasives.failwith("");
      }
...
function slice(param, param$1, b) {
  var x2 = param$1[1];
  var y2 = param$1[0];
  var x1 = param[1];
  var y1 = param[0];
  var new_b = $$Array.make_matrix(y2 - y1 | 0, x2 - x1 | 0, Caml_array.caml_array_get(Caml_array.caml_array_get(b, 0), 0));
  for(var i = 0 ,i_finish = (y2 - y1 | 0) - 1 | 0; i <= i_finish; ++i){
    for(var j = 0 ,j_finish = (x2 - x1 | 0) - 1 | 0; j <= j_finish; ++j){
      Caml_array.caml_array_set(Caml_array.caml_array_get(new_b, i), j, Caml_array.caml_array_get(Caml_array.caml_array_get(b, y1 + i | 0), x1 + j | 0));
    }
  }
  return new_b;
}
...
var Board = /* module */[
  ...
  /* dup */dup,
  /* for_all_row */for_all_row,
  /* slice */slice
];

function print$1(param) {
  return print(Pervasives.print_int, param);
}

var hoge = $$Array.make_matrix(5, 5, 0);
...
var Caml_int64              = __webpack_require__(11);
...
var Curry                   = __webpack_require__(1);
var Js_exn                  = __webpack_require__(22);
var Caml_array              = __webpack_require__(3);
var Caml_exceptions         = __webpack_require__(6);
var Caml_builtin_exceptions = __webpack_require__(0);
...
function draw_block(ctx, block_w, block_h, x, y) {
  ctx.fillRect(Caml_int32.imul(block_w, x), Caml_int32.imul(block_h, y), block_w - 1 | 0, block_h - 1 | 0);
  ctx.strokeRect(Caml_int32.imul(block_w, x), Caml_int32.imul(block_h, y), block_w - 1 | 0, block_h - 1 | 0);
  return /* () */0;
}

function render(board, current, ws, hs, ctx, _) {
  var match = current[0];
  var currentY = match[/* currentY */2];
  var currentX = match[/* currentX */1];
  var current$1 = match[/* shape */0];
  var match_000 = Util.Board[/* width */2](board[0]);
  var match_001 = Util.Board[/* height */3](board[0]);
  var rows = match_001;
  var cols = match_000;
  ctx.clearRect(0, 0, ws, hs);
  ctx.strokeStyle = "black";
  for(var x = 0 ,x_finish = cols - 1 | 0; x <= x_finish; ++x){
    for(var y = 0 ,y_finish = rows - 1 | 0; y <= y_finish; ++y){
      var clr = Util.Board[/* get */7](y, x, board[0]);
      if (clr !== 0) {
        ctx.fillStyle = Caml_array.caml_array_get(colors, (clr - 1 | 0) % 7);
        draw_block(ctx, Caml_int32.div(ws, cols), Caml_int32.div(hs, rows), x, y);
      }
  ...
  ctx.fillStyle = "red";
  ctx.strokeStyle = "black";
  for(var y$1 = 0; y$1 <= 3; ++y$1){
    for(var x$1 = 0; x$1 <= 3; ++x$1){
      var clr$1 = Util.Board[/* get */7](y$1, x$1, current$1);
      if (clr$1 !== 0) {
        ctx.fillStyle = Caml_array.caml_array_get(colors, (clr$1 - 1 | 0) % 7);
        draw_block(ctx, Caml_int32.div(ws, cols), Caml_int32.div(hs, rows), currentX + x$1 | 0, currentY + y$1 | 0);
      }
...
function copy(b1, b2, i, j) {
  return Util.Board[/* copy */11](b1, b2, 0, i, j);
}

var shapes = /* array */[
  Util.Board[/* of_matrix */10](/* array */[
        /* int array */[
          1,
          1,
          1,
...
function new_shape(sp, _) {
  var id = Random.$$int(shapes.length);
  var current = Util.Board[/* dup */15](Caml_array.caml_array_get(shapes, id));
  Util.Board[/* update */9]((function (x) {
          return Caml_int32.imul(x, id + 1 | 0);
        }), current);
  return /* record */[
          /* shape */current,
          /* currentX */sp,
...
function freeze(board, param) {
  return copy(param[/* shape */0], board, param[/* currentY */2], param[/* currentX */1]);
}

function clear_lines(board) {
  var match_000 = Util.Board[/* width */2](board);
  var match_001 = Util.Board[/* height */3](board);
  var w = match_000;
  var line_is_full = function (i) {
    return Util.Board[/* for_all_row */16]((function (param) {
                  return Caml_obj.caml_notequal(0, param);
                }), i, board);
  };
  var _i = match_001 - 1 | 0;
  while(true) {
    var i = _i;
    if (i < 0) {
      return /* () */0;
      ...
      sound.play();
      for(var j = i; j >= 1; --j){
        Util.Board[/* set_row */5](j, board, Util.Board[/* get_row */6](j - 1 | 0, board));
      }
      Util.Board[/* set_row */5](0, board, Caml_array.caml_make_vect(w, 0));
      continue ;
...
function valid(offsetX, offsetY, board, param) {
  var current = param[/* shape */0];
  var offsetX$1 = param[/* currentX */1] + offsetX | 0;
  var offsetY$1 = param[/* currentY */2] + offsetY | 0;
  var match_000 = Util.Board[/* width */2](board);
  var match_001 = Util.Board[/* height */3](board);
  var h = match_001;
  var w = match_000;
  ...
  while(true) {
    ...
    } else if (Util.Board[/* get */7](y, x, current) !== 0) {
      var match_000$1 = x + offsetX$1 | 0;
      var match_001$1 = y + offsetY$1 | 0;
      var yo = match_001$1;
      var xo = match_000$1;
      if (yo < 0 || xo < 0 || yo >= h || xo >= w || Util.Board[/* get */7](yo, xo, board) !== 0) {
        return /* tuple */[
                +(offsetY$1 === 1),
                /* false */0
              ];
...
function tick(board, current) {
  var new_current_000 = /* shape */current[/* shape */0];
  var new_current_001 = /* currentX */current[/* currentX */1];
  var new_current_002 = /* currentY */current[/* currentY */2] + 1 | 0;
  var new_current = /* record */[
    new_current_000,
    new_current_001,
    new_current_002
  ];
  var match = valid(0, 0, board, new_current);
  if (match[1]) {
    return /* tuple */[
            board,
            new_current,
    ...
    if (match[0]) {
      return /* tuple */[
              board,
              new_shape(Util.Board[/* width */2](board) / 2 | 0, /* () */0),
              /* true */1
            ];
    } else {
      return /* tuple */[
...
function tick$1(board_ref, current_ref, _) {
  var match = tick(board_ref[0], current_ref[0]);
  if (match[2]) {
    Util.Board[/* update */9]((function () {
            return 0;
          }), board_ref[0]);
    current_ref[0] = new_shape(Util.Board[/* width */2](board_ref[0]) / 2 | 0, /* () */0);
  } else {
    board_ref[0] = match[0];
  }
  current_ref[0] = match[1];
  return /* () */0;
}

exports.copy        = copy;
exports.shapes      = shapes;
exports.new_shape   = new_shape;
exports.freeze      = freeze;
exports.clear_lines = clear_lines;
exports.valid       = valid;
exports.tick        = tick$1;
/* shapes Not a pure module */
...
var Tetris     = __webpack_require__(18);
var Controller = __webpack_require__(34);

function new_game(row, col) {
  var board = [Util.Board[/* make */1](row, col, 0)];
  var current = [Tetris.new_shape(col / 2 | 0, /* () */0)];
  var canvas = document.getElementsByTagName("canvas")[0];
  var ctx = canvas.getContext("2d");
  var render = function (param) {
    return Render.render(board, current, 300, 600, ctx, param);
  };
  Controller.controller_set(board, current, 300, 600, ctx);
  var play = function () {
    render(/* () */0);
    return Tetris.tick(board, current, /* () */0);
  };
  setInterval(play, 500);
  return /* () */0;
}

var main = new_game(20, 10);
...
var Sys         = __webpack_require__(33);
var Caml_obj    = __webpack_require__(2);
var Caml_format = __webpack_require__(9);
...
function controller_set(board_ref, current_ref, ws, hs, ctx) {
  document.body.onkeydown = (function (e) {
      var match = e.keyCode;
      var switcher = match - 37 | 0;
      if (switcher > 3 || switcher < 0) {
        return /* () */0;
      } else {
        switch (switcher) {
          case 0 : 
              if (Tetris.valid(-1, 0, board_ref[0], current_ref[0])[1]) {
                var init = current_ref[0];
                current_ref[0] = /* record */[
                  /* shape */init[/* shape */0],
                  /* currentX */current_ref[0][/* currentX */1] - 1 | 0,
                  /* currentY */init[/* currentY */2]
                ];
              }
              return Render.render(board_ref, current_ref, ws, hs, ctx, /* () */0);
          case 1 : 
              Util.Board[/* rotate */13](current_ref[0][/* shape */0]);
              if (!Tetris.valid(0, 0, board_ref[0], current_ref[0])[1]) {
                Util.Board[/* rotate_rev */14](current_ref[0][/* shape */0]);
              }
              return Render.render(board_ref, current_ref, ws, hs, ctx, /* () */0);
          case 2 : 
              if (Tetris.valid(1, 0, board_ref[0], current_ref[0])[1]) {
                var init$1 = current_ref[0];
                current_ref[0] = /* record */[
                  /* shape */init$1[/* shape */0],
                  /* currentX */current_ref[0][/* currentX */1] + 1 | 0,
                  /* currentY */init$1[/* currentY */2]
                ];
              }
              return Render.render(board_ref, current_ref, ws, hs, ctx, /* () */0);
          case 3 : 
              if (Tetris.valid(0, 1, board_ref[0], current_ref[0])[1]) {
                var init$2 = current_ref[0];
                current_ref[0] = /* record */[
                  /* shape */init$2[/* shape */0],
                  /* currentX */init$2[/* currentX */1],
                  /* currentY */current_ref[0][/* currentY */2] + 1 | 0
                ];
              }
              return Render.render(board_ref, current_ref, ws, hs, ctx, /* () */0);
...
exports.controller_set = controller_set;
/* Util Not a pure module */
