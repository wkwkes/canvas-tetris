...
function copy(b1, b2, i, j) {
  return Util.Board[/* copy */9](b1, b2, 0, i, j);
}

var shapes = /* array */[
  Util.Board[/* of_matrix */8](/* array */[
        /* int array */[
          1,
          1,
          1,
...
function new_shape() {
  ...
  var current = Util.Board[/* dup */12](Caml_array.caml_array_get(shapes, id));
  Util.Board[/* update */7]((function (x) {
...
function freeze(board, param) {
  return copy(param[/* shape */0], board, param[/* y */2], param[/* x */1]);
}

function clear_lines(board) {
  var line_is_full = function (i) {
    return Util.Board[/* for_all_row */13]((function (param) {
  ...
  while(true) {
    ...
    if (i < 0) {
      ...
      for(var j = i; j >= 1; --j){
        Util.Board[/* set_row */4](j, board, Util.Board[/* get_row */5](j - 1 | 0, board));
      }
      Util.Board[/* set_row */4](0, board, Caml_array.caml_make_vect(10, 0));
      continue ;
...
function valid(offsetX, offsetY, board, param) {
  ...
  var offsetX$1 = param[/* x */1] + offsetX | 0;
  var offsetY$1 = param[/* y */2] + offsetY | 0;
  var _y = 0;
  var _x = 0;
  while(true) {
    var x = _x;
    ...
    } else if (Util.Board[/* get */6](y, x, shape) !== 0) {
      var match_000 = x + offsetX$1 | 0;
      var match_001 = y + offsetY$1 | 0;
      var yo = match_001;
      var xo = match_000;
      if (yo < 0 || xo < 0 || yo >= 20 || xo >= 10 || Util.Board[/* get */6](yo, xo, board) !== 0) {
        return /* tuple */[
                +(offsetY$1 === 1),
                /* false */0
              ];
...
function tick(board, current) {
  var new_cur_000 = /* shape */current[/* shape */0];
  var new_cur_001 = /* x */current[/* x */1];
  var new_cur_002 = /* y */current[/* y */2] + 1 | 0;
  var new_cur = /* record */[
    new_cur_000,
    new_cur_001,
    new_cur_002
  ];
  var match = valid(0, 0, board, new_cur);
  if (match[1]) {
    return /* tuple */[
            board,
            new_cur,
...
function tick$1(board_ref, current_ref, _) {
  ...
  if (match[2]) {
    Util.Board[/* update */7]((function () {
            return 0;
          }), board_ref[0]);
    current_ref[0] = new_shape(/* () */0);
  } else {
    board_ref[0] = match[0];
  }
...
function draw_block(x, y) {
  var h = 30;
  var w = 30;
  ctx.fillRect(Caml_int32.imul(w, x), Caml_int32.imul(h, y), w - 1 | 0, h - 1 | 0);
  ctx.strokeRect(Caml_int32.imul(w, x), Caml_int32.imul(h, y), w - 1 | 0, h - 1 | 0);
  return /* () */0;
}

function render(b_ref, c_ref, _) {
  var match = c_ref[0];
  var y = match[/* y */2];
  var x = match[/* x */1];
  var shape = match[/* shape */0];
  ctx.clearRect(0, 0, 300, 600);
  ctx.strokeStyle = "black";
  for(var i = 0; i <= 9; ++i){
    for(var j = 0; j <= 19; ++j){
      var clr = Util.Board[/* get */6](j, i, b_ref[0]);
      if (clr !== 0) {
  ...
  for(var i$1 = 0; i$1 <= 3; ++i$1){
    for(var j$1 = 0; j$1 <= 3; ++j$1){
      var clr$1 = Util.Board[/* get */6](i$1, j$1, shape);
      if (clr$1 !== 0) {
        ctx.fillStyle = Caml_array.caml_array_get(colors, (clr$1 - 1 | 0) % 7);
        draw_block(x + j$1 | 0, y + i$1 | 0);
      }
...
function controller_set(b_ref, c_ref) {
  document.body.onkeydown = (function (e) {
      ...
      if (switcher > 3 || switcher < 0) {
        ...
        switch (switcher) {
          case 0 : 
              if (valid(-1, 0, b_ref[0], c_ref[0])[1]) {
                var init = c_ref[0];
                c_ref[0] = /* record */[
                  /* shape */init[/* shape */0],
                  /* x */c_ref[0][/* x */1] - 1 | 0,
                ...
                return render(b_ref, c_ref, /* () */0);
              } else {
                return /* () */0;
              }
              break;
          case 1 : 
              Util.Board[/* rotate */10](c_ref[0][/* shape */0]);
              if (!valid(0, 0, b_ref[0], c_ref[0])[1]) {
                Util.Board[/* rotate_rev */11](c_ref[0][/* shape */0]);
              }
              return render(b_ref, c_ref, /* () */0);
          case 2 : 
              if (valid(1, 0, b_ref[0], c_ref[0])[1]) {
              ...
              break;
          case 3 : 
              if (valid(0, 1, b_ref[0], c_ref[0])[1]) {
                var init$2 = c_ref[0];
                c_ref[0] = /* record */[
...
var board = [Util.Board[/* make */1](20, 10, 0)];

var current = [new_shape(/* () */0)];

controller_set(board, current);

function play() {
  render(board, current, /* () */0);
  return tick$1(board, current, /* () */0);
}
...
exports.cols           = cols;
exports.rows           = rows;
exports.w_size         = w_size;
exports.h_size         = h_size;
...
var Int64                   = __webpack_require__(25);
...
var Caml_md5                = __webpack_require__(29);
var Pervasives              = __webpack_require__(6);
var Caml_string             = __webpack_require__(3);
var Caml_missing_polyfill   = __webpack_require__(15);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Sys         = __webpack_require__(31);
var Caml_obj    = __webpack_require__(2);
var Caml_format = __webpack_require__(8);
